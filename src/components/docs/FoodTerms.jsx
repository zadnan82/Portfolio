      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                By downloading, installing, or using  Giggli - Food Ingredients Scanner mobile application
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">2.1  Giggli - Food Ingredients Scanner </h3>
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          ...
          <p className="mt-4 text-xs">
            By using  Giggli - Food Ingredients Scanner, you acknowledge that you have read, 
